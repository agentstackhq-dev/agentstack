...
- A broad CLI router and generated package scripts for inspection, validation, env, sync, aggregate preview/production provider planning, aggregate preview/production local and live provider reconciliation artifacts, provider plan/inspect/apply/inventory/link/adopt, preview rehearsal, production rehearsal, mobile build rehearsal, and observability.
