...
1. Finish provider integration gaps first:
   ...
   - Expand Vercel live inventory/readiness beyond bounded preview inventory and proof-only production env-list diagnostics only when production read semantics are explicitly designed.
