...
- Generated root package scripts added `lint` as a concrete quality command, and generated validation docs described that checkpoint's quality sequence. The current quality sequence is documented above as lint/typecheck/build/test.
