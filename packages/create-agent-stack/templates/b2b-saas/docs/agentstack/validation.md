...
Future live validation will be a separate evidence category from structural validation, local quality validation, and local-cloud rehearsal. Until a command explicitly prints live evidence, treat all validation output as local evidence only.
