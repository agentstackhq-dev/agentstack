...
- Treat live provider inventory and provider proof identity as ambiguous. Sanitized `missing=` labels and `Identity proof requirements:` summaries explain what proof is absent; they are not exact provider identity and must not justify link/adopt writes.
