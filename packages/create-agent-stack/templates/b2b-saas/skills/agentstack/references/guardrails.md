...
- Treat live inventory `missing=` labels plus provider proof and live link/adopt `Identity proof requirements:` summaries as sanitized blockers only. They do not prove exact provider identity.
