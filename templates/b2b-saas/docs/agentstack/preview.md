...
Use this runbook to rehearse the framework path and choose explicit provider inspect/apply only when diagnostics, Convex execution, Vercel preview/production env-list inspection, Vercel preview deploy execution, or EAS preview env-list inspection are required.
