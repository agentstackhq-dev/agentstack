...
6. Open the deployed URL, sign in with Clerk, wait for protected Convex data to load, and run:
...
7. Check the local redacted evidence bundle before marking Evidence complete:
